...
<html>
    ...
    <div class="container">
        ...
        <thead><th>ClientID</th><th>SNPclient</th><th>CivilPassportDetails</th><th>ForeignPassportDetails</th><th>VisaAvailability</th><th>VisaDetails</th><th>DiscountForRegularCustomers</th><th>Удалить</th></thead>
        <?php
        ...
        <table class="table table-striped">
            ...
            <thead><th>UserID</th><th>FIO</th><th>Login</th><th>Telephone</th><th>Password</th><th>BirthDate</th><th>CitysID</th></thead>
            <?php
