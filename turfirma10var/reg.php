...
<body>
    <div>
        <form action="add_user_controller.php" method="POST" role='form'>
            ...
            <div class="form-group">
                ...
                <select id="citys" name="citys" onchange="toggleOtherCityInput(this)">
                ...
                <div class="form-group" id="otherCityDiv" style="display: none;">
                    <label for="otherCity">Введите название города:</label>
                    <input type="text" class="form-control" id="otherCity" name="otherCity">
                </div>
            </div>
    ...
    function toggleOtherCityInput(select) {
        const otherCityDiv = document.getElementById('otherCityDiv');
        if (select.value === 'other') {otherCityDiv.style.display = 'block';} 
        else {otherCityDiv.style.display = 'none';}
    }
</script>
</body>
</html>